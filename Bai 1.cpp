...
// Ham tinh S(n) = √5 + √5 + ... + √5 (co n dau can)
...
// Ham tinh S(n) = 1*2 + 2*3 + 3*4 + ... + n*(n + 1)
...
// Ham tinh S(n) = 1 + √1 + 2/2 + √3! + 3/3 + √4! + ... + n/n + √(n + 1)!
